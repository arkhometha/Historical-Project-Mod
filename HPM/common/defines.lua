...
country = {
    ...
    GOLD_TO_CASH_RATE = 20, -- Amount of money generated per gold unit
    ...
    PROVINCE_OVERSEAS_PENALTY = 0.020, -- Each province req. this many goods flagged as overseas penalty
